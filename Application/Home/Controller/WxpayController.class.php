...
class WxpayController extends JsApiCommonController {

    protected $wxpay_model;

    protected function _initialize(){
        $this->wxpay_model = new WxpayModelController();
    }

    public function index(){
        $this->assign('wxPayUrl', $this->wxpay_model->retWxPayUrl());
        $this->display("Home@Wxpay/index");
